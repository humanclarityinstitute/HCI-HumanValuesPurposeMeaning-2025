...
Part of the Human Clarity Institute’s **AI–Human Experience Data Series**, examining how adults understand their personal values, sense of meaning, life direction, fulfilment, behaviour alignment, wellbeing, and how these interact with digital and AI-mediated environments.
...
**Themes:**  
values, meaning, purpose, identity alignment, behaviour alignment, wellbeing, digital influence, AI influence, self-trust
...
“How can I figure out what truly matters to me and whether my daily behaviour aligns with my core values?”
...
- **Files included:**  
  - Human_Values_Purpose_Meaning_raw20251125.csv  
  - Human_Values_Purpose_Meaning_clean20251125.csv  
  - Human_Values_Purpose_Meaning_dictionary.csv  
  - README.md  
  - sha256.txt  
...
5. Confirmed valid numeric ranges for Likert (1–7)  
6. Checked for malformed characters and formatting issues  
7. Applied snake_case naming to all variables  
8. Verified demographic consistency  
9. Prepared README + data dictionary  
10. Generated SHA-256 checksums for all released files  
...
| Version | Date       | Change               |
|---------|------------|----------------------|
| v1.1    | 2025-12-04 | Removed Prolific participant IDs; updated files accordingly     |
